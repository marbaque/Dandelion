...
add_theme_support('soil-google-analytics', 'UA-XXXXX-Y'); //Enable Google Analytics (loads in the footer, otherwise add 'wp-header')
  ...
  if (!isset($display)) {
    $conditionalCheck = new ConditionalTagCheck(
      ...
      [
        ...
        'is_front_page',
        'is_page',
        ['is_post_type_archive', ['proyecto', 'investigadores']],
        ['is_singular', ['proyectos']],
